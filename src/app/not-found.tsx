  ...
  return (
    <main className="grid min-h-screen place-items-center bg-background px-6 py-24 sm:py-32 lg:px-8">
      <div className="text-center">
        ...
        <p className="mt-6 text-base leading-7 text-text-secondary">Sorry, we couldn't find the page you're looking for.</p>
        <div className="mt-10 flex items-center justify-center gap-x-6">
          ...
          <Link href="/support" className="text-sm font-semibold text-text">
