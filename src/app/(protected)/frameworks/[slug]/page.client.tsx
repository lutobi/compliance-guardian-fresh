...
const ControlItem = dynamic(() => import('@/components/framework/ControlItem'), { ssr: false })
const FrameworkDashboard = dynamic(() => import('@/components/framework/FrameworkDashboard'), { ssr: false })
